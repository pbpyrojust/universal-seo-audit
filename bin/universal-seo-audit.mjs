...
Commands:
  ...
  lighthouse          Show Lighthouse and agentic scoring usage note
...
switch (command) {
  ...
  case "lighthouse": console.log("Use --lighthouse with the audit command to run a real Lighthouse performance pass per page. Agentic readiness scoring writes seo-agentic.csv on every scan."); break;
